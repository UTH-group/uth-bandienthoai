...
<body>
          ...
          <ul class="glide__slides">
            <li class="glide__slide">
              <div class="center">
                ...
                <div class="right">
                  <img class="img1" src="./images/cart-item2.jpg" alt="">
                </div>
              </div>
            </li>
            <li class="glide__slide">
              <div class="center">
                ...
                <div class="right">
                  <img class="img2" src="./images/cart-item1.jpg" alt="">
                </div>
              </div>
            </li>
          </ul>
  ...
  <section class="section category">
    <div class="cat-center">
      ...
      <div class="cat">
        <img src="./images/cart-item1.jpg" alt="" />
        <div>
          <p>SAMSUNG</p>
        </div>
      </div>
    ...
    <div class="popup-content">
      ...
      <div class="popup-left">
        <div class="popup-img-container">
          <img class="popup-img" src="./images/main-logo.png" alt="popup">
        </div>
      </div>
