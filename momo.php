...
$orderIdReal = isset($_GET['orderId']) ? strval($_GET['orderId']) : time() . "";
$orderId = time() . "";
$redirectUrl = "http://localhost:3000/config/success_momo.php?orderIdReal=$orderIdReal";
$ipnUrl = "http://localhost:3000/success.php";
$extraData = "";
